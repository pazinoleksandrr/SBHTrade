                    ...
                    <li>
                        <a href="<?php echo admin_url('leads/delete/' . $lead->id); ?>" class="text-danger delete-text _delete"
                           data-toggle="tooltip" title="">
                            ...
                            <?php echo _l('client_edit_delete_tooltip_'); ?>
                        </a>
                    </li>
                <?php } ?>
            </ul>
    ...
    <div class="row">
        <div class="lead-view<?php if (!isset($lead)) {
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500"><?php echo _l('client_additional_contact_'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->additional_contact != '' ? $lead->additional_contact : '-') ?>
                    </dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_phonenumber'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->phonenumber != '' ? '<a href="tel:' . mask_phone($lead->phonenumber) . '">' . mask_phone($lead->phonenumber) . '</a>' : '-') ?>
                    </dd>
        ...
        <div class="lead-edit<?php if (isset($lead)) {
            ...
            <div class="col-md-6">
                ...
                <?php $value = (isset($lead) ? $lead->first_name : ''); ?>
                <?php echo render_input('first_name', 'lead_add_edit_first_name', $value); ?>
                <?php $value = (isset($lead) ? $lead->last_name : ''); ?>
                <?php echo render_input('last_name', 'lead_add_edit_last_name', $value); ?>
                ...
                <?php $value = (isset($lead) ? $lead->additional_contact : ''); ?>
                <?php echo render_input('additional_contact', 'client_additional_contact_', $value); ?>
                ...
                <?php /*}*/
                $permission = has_permission('phone_number', '', 'hide');
                $value = (isset($lead) ? mask_phone($lead->phonenumber) : ''); ?>
                <?php echo ($permission && !is_admin()) ? '' : render_input('phonenumber', 'lead_add_edit_phonenumber', $value); ?>
                <!--<div class="form-group">
