    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title">
            <?php if (isset($lead)) {
                ...
                echo _l('add_new', _l('client_lowercase_'));
            }
                ...
                <div class="top-lead-menu">
                    <?php if (isset($lead)) { ?>
                        ...
                        */?>
                                        ...
                                        <li role="presentation">
                                            <a href="#orders"
                                               onclick="init_rel_orders_table(<?php echo $lead->id; ?>,'lead','.table-rel-orders-leads');"
                                               aria-controls="tab_orders_leads" role="tab" data-toggle="tab">
                                                <?php echo _l('client_orders_');
                                                /*if ($total_orders > 0) {
                                                    echo ' <span class="badge">' . $total_orders . '</span>';
                                                }*/
                                                ?>
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#positions"
                                               onclick="init_rel_positions_table(<?php echo $lead->id; ?>,'lead','.table-rel-positions-leads');"
                                               aria-controls="tab_positions_leads" role="tab" data-toggle="tab">
                                                <?php echo _l('client_positions_');
                                                /*if ($total_positions > 0) {
                                                    echo ' <span class="badge">' . $total_positions . '</span>';
                                                }*/
                                                ?>
                                            </a>
                                        </li>
                                        ...
                                        <li role="presentation">
                                            <a href="#finance"
                                               onclick="init_rel_finance_table(<?php echo $lead->id; ?>,'lead','.table-rel-finance-leads');"
                                               aria-controls="tab_finance_leads" role="tab" data-toggle="tab">
                                                <?php echo _l('client_finance_');
                                                /*if ($total_finance > 0) {
                                                    echo ' <span class="badge">' . $total_finance . '</span>';
                                                }*/
                                                ?>
                                            </a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#accounts"
                                               onclick="init_rel_accounts_table(<?php echo $lead->id; ?>,'lead','.table-rel-accounts-leads');"
                                               aria-controls="tab_accounts_leads" role="tab" data-toggle="tab">
                                                <?php echo _l('client_accounts_');
                                                /*if ($total_tasks > 0) {
                                                    echo ' <span class="badge">' . $total_tasks . '</span>';
                                                }*/
                                                ?>
                ...
                <div class="tab-content">
                    ...
                    <?php
                        ...
                        <div role="tabpanel" class="tab-pane" id="orders">
                            <?php init_relation_orders_table(['data-new-rel-id' => $lead->id, 'data-new-rel-type' => 'lead']); ?>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="positions">
                            <?php init_relation_positions_table(['data-new-rel-id' => $lead->id, 'data-new-rel-type' => 'lead']); ?>
                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="finance">
                            <?php init_relation_finance_table(['data-new-rel-id' => $lead->id, 'data-new-rel-type' => 'lead']); ?>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="accounts">
                            <?php init_relation_accounts_table(['data-new-rel-id' => $lead->id, 'data-new-rel-type' => 'lead']); ?>
                        </div>
