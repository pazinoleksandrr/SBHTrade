        ...
        <li class="kan-ban-col-wrapper">
            <div class="border-right panel_s">
                ...
                <div class="panel-heading tw-bg-neutral-700 tw-text-white"
                    ...
                    <?php $summary[$statusSummaryIndex = array_search($status['id'], array_column($summary, 'id'))]['value'];/*echo app_format_money(
        $summary[$statusSummaryIndex = array_search($status['id'], array_column($summary, 'id'))]['value'],
        $base_currency
    ); */?><!-- ---> <small><?php echo $summary[$statusSummaryIndex]['total'] . ' ' . _l('clients_') ?></small>
