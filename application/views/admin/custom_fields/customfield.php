                    ...
                    <div class="panel-body">
                        ...
                        <div class="select-placeholder form-group">
                            ...
                            <select name="fieldto" id="fieldto" class="selectpicker" data-width="100%"
                                ...
                                <option value="accounts" <?php if (isset($custom_field) && $custom_field->fieldto == 'accounts') {
                                    echo 'selected';
                                } ?>><?php echo _l('custom_field_accounts_'); ?></option>
                                <option value="finance" <?php if (isset($custom_field) && $custom_field->fieldto == 'finance') {
                                    echo 'selected';
                                } ?>><?php echo _l('custom_field_finance_'); ?></option>
                                <option value="orders" <?php if (isset($custom_field) && $custom_field->fieldto == 'orders') {
                                    echo 'selected';
                                } ?>><?php echo _l('custom_field_orders_'); ?></option>
                                <option value="positions" <?php if (isset($custom_field) && $custom_field->fieldto == 'positions') {
                                    echo 'selected';
                                } ?>><?php echo _l('custom_field_positions_'); ?></option>
