...
<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('home_deposit_records_'); ?>">
        ...
        <div class="col-md-12">
            <div class="panel_s">
                <div class="panel-body padding-10">
                    ...
                    <div class="tw-flex tw-justify-between tw-items-center tw-p-1.5">
                        <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse">
                            ...
                            <span class="tw-text-neutral-700">
                                <?php echo _l('home_deposit_records_'); ?>
                            </span>
                        </p>
                        <div class="fc-toolbar-chunk"><h4 class="fc-toolbar-title"><?php echo _l('home_deposit_chart_'); ?></h4></div>
                        <div class="tw-divide-x tw-divide-solid tw-divide-neutral-300 tw-space-x-2 tw-flex tw-items-center">
                            <select class="selectpicker tw-pr-2" name="status_deposit"
                            ...
                            <div class="dropdown pull-right mright10">
                                <a href="#" id="DepositChartmode" class="dropdown-toggle tw-pl-2" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <span id="Deposit-chart-name" data-active-chart="weekly">
                                        <?php echo _l('weekly') ?>
                                    </span>
                                    <i class="fa fa-caret-down" aria-hidden="true"></i>
                                </a>
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="DepositChartmode">
                                    <li>
                                        <a href="#" data-type="weekly"
                                            onclick="update_deposit_statistics(this); return false;">
                                            <?php echo _l('weekly') ?>
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <canvas height="130" class="payments-chart-dashboard" id="deposit-statistics"></canvas>
                </div>
            </div>
        </div>
    </div>
