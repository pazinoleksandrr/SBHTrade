...
<div class="modal fade<?php if (isset($task)) {
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php } ?>
                        <div class="row">
                            <input type="hidden" name="rel_type" id="rel_type" value="lead">
                            <!--<div class="col-md-6">
                                <div class="form-group">
                                    <label for="rel_type"
                            ...
                            <div class="col-md-6">
                                <div class="form-group<?php if ($rel_id == '') {
                                    ...
                                    <label for="rel_id" class="control-label"><?php echo _l('client_'); ?></label>
    ...
    <script>
        ...
        function task_rel_select() {
            ...
            custom_ajax_search(_rel_type.val(), _rel_id, serverData);
        }
        ...
        function custom_ajax_search(type, selector, server_data, url){
            var ajaxSelector = $('body').find(selector);
            if(ajaxSelector.length){
                var options = {
                    ajax: {
                        url: (typeof(url) == 'undefined' ? admin_url + 'tasks/get_clients_based_staff_role' : url),
                        data: function () {
                            var data = {};
                            data.type = type;
                            data.rel_id = '';
