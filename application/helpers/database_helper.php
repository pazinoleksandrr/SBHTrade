...
function add_notification($values)
{
    ...
    if (is_client_logged_in()) {
        ...
        $data['fromuserid']    = get_staff_user_id()?get_staff_user_id():'Added from Api';
        $data['fromclientid']  = 0;
        $data['from_fullname'] = get_staff_user_id()?get_staff_full_name(get_staff_user_id()):'Added from Api';
    }
