...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        [
            'path'      => 'admin/dashboard/widgets/deposits_chart',
            'container' => 'left-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/withdrawals_chart',
            'container' => 'left-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/effectiveness_report',
            'container' => 'left-8',
        ],
        [
            'path'      => 'admin/dashboard/widgets/staff_report',
            'container' => 'left-8',
        ],
        [
