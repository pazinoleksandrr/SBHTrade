...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (is_staff_member()) {
        $CI->app_menu->add_sidebar_menu_item('deposit', [
            'slug'     => 'deposit',
            'name'     => _l('als_deposit_'),
            'href'     => admin_url('finance/deposit'),
            'icon'     => 'fa fa-indent',
            'position' => 46,
            'badge'    => [],
        ]);
    ...
    if (is_staff_member()) {
        $CI->app_menu->add_sidebar_menu_item('withdrawal', [
            'slug'     => 'withdrawal',
            'name'     => _l('als_withdrawal_'),
            'href'     => admin_url('finance/withdrawal'),
            'icon'     => 'fa fa-outdent',
            'position' => 47,
            'badge'    => [],
        ]);
    ...
    if (is_admin() || (is_staff_member() && is_lead_staff())) {
        $CI->app_menu->add_sidebar_menu_item('departments', [
            'name'     => _l('als_departments_'),
            'href'     => admin_url('deps'),
            'icon'     => 'fa fa-id-card',
            'position' => 50,
            'badge'    => [],
    ...
    // Utilities
    $CI->app_menu->add_sidebar_menu_item('additional', [//'utilities', [
        'collapse' => true,
        'name'     => _l('als_additional_'),//'als_utilities'),
        'position' => 55,
        'icon'     => 'fa fa-cogs',
        'badge'    => [],
    ]);
    ...
    if (is_admin()) {
        $CI->app_menu->add_sidebar_children_item('additional', [
            'slug'     => 'announcements',
...
//    }
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_menu_item('voip', [
            'href'     => admin_url('voip'),
            'name'     => _l('voip'),
            'position' => 56,
            'badge'    => [],
