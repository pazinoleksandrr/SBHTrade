 ...
 * @return array a JSON object with an error message
 */
function createResourceRoot(){
    helper('jwt/error_code');
    return [
        "code" => PROHIBITED,
 ...
 * @return array the id of the newly-created collection member
 */
function createResourceElement($table, $input_fields, $input_types, $input_values){
    ...
    $input_fields_question_marks = implode(",",array_fill(0,$input_values_count,"?"));

    return database_query(
        "INSERT INTO ".$table." (".$input_fields_squashed.") VALUES (".$input_fields_question_marks.")",
