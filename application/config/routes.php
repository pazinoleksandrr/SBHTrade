...
//api routes
$route['crm/add-user'] = 'api/client';
$route['crm/get-user'] = 'api/client';
$route['crm/edit-user'] = 'api/client/edit';
//$route['crm/sync-user'] = 'api/client/synced';

$route['crm/add-account'] = 'api/accounts';
$route['crm/get-account'] = 'api/accounts';
$route['crm/edit-account'] = 'api/accounts/edit';

$route['crm/add-finance'] = 'api/finance';
$route['crm/get-finance'] = 'api/finance';
$route['crm/edit-finance'] = 'api/finance/edit';

$route['crm/add-order'] = 'api/orders';
$route['crm/get-order'] = 'api/orders';
$route['crm/edit-order'] = 'api/orders/edit';
$route['crm/delete-order'] = 'api/orders/delete';

$route['crm/add-position'] = 'api/positions';
$route['crm/get-position'] = 'api/positions';
$route['crm/edit-position'] = 'api/positions/edit';
$route['crm/delete-position'] = 'api/positions/delete';

$route['crm/events'] = 'sse/events/get';